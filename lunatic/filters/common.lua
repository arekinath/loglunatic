...
local pattern_lib = {
	...
	ipv6tail_nocolon = (P(":") * V("v6part") * V("ipv6tail_nocolon")) + (P(":") * V("v6part")) + P("::"),
	ipv6tail = (P("::") * V("v6part") * V("ipv6tail_nocolon")) + (P(":") * V("v6part") * V("ipv6tail")) + (P(":") * V("v6part")) + P("::"),
	ipv6 = (P("::") * V("v6part") * V("ipv6tail_nocolon")) + (V("v6part") * V("ipv6tail")) + P("::"),
	ip = V("ipv4") + V("ipv6"),
